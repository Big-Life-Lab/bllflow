...
# PMML Export
pkg.globals$PMML.variables <- "variables"
pkg.globals$PMML.variable_details <- "variable-details"
pkg.globals$PMML.model_steps <- "model-steps"

pkg.globals$PMML.filePath <- "filePath"
pkg.globals$PMML.step <- "step"
pkg.globals$PMML.fileType <- "fileType"
