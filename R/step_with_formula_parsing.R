...
#'
#' @param function_object_list List containing function calls and their arguments
#' @param working_data data.frame that is passed to recipes as training data
#' @param variables data.frame containing specific module steps depending on the variable
#'
