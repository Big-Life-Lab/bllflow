...
```{r}
WriteDDIPopulatedMSW(pbcDDI, "../inst/extdata/PBC/vignette-testing/", 
                  "testing.csv", 
                  "newName.csv")
```
...
##### Example 4. More general DDI utily functions 
...
pbcDDI <- ReadDDI(file.path(getwd(), "../inst/extdata/test-folder/DDI"), 
                "pbcDDI.xml")
...
descrForCCHS <- GetDDIDescription(pbcDDI)
