...
Example 1: Get the varialbe metadata for variableDetails sheet from DDI and add 
...
TODO: pbc-DDI <- readDDI(DDIPath = ddiPath, DDIFile = 'pbc-DDI.xml')
pbcModel <- BLLFlow(pbc, variables, variableDetails, pbc-DDI)
```
