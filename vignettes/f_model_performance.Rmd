...
plots to help report model performance. Most of these tools support predictive models, including calibration plots of observed versus predicted risk estimates that use `summaryData` tables specified in the Model Specification Workbook.
