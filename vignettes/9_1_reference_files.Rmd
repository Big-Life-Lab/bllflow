...
## `bllFlow-variables`
`bllFlow-variables` is the data file that describes labels and metadata in bblFlow. Add to your own `bllFlow-variables` or make a [pull request](https://github.com/big-Life-Lab/bllflow/pulls). 
...
dt <- read.csv(system.file("extdata", "bllFlow-variables.csv", package = "bllFlow"))
