...
pbcModel <- UpdateMSW(bllModel = pbcModel, newDDI = ddi) 

pbcModelWithLongTable <- SummaryDataLong(tableOne = TableOne, bllFlowModel = pbcModel, longTable = TableOneLong)
```
...
```{r}
checkedLongTable <- CheckSmallCells(pbcModelWithLongTable$longTable)
```

For a print of the found rows pass print as TRUE
```{r}
checkedLongTable <- CheckSmallCells(pbcModelWithLongTable$longTable, print = TRUE)
```
