...
1) Functions -- where the data and variables are specified as attributes within the function. _bllflow_ adds to the functions that already exist in the `sjmisc` package.
...
The effects of all data preparation functions can be logged and printed. Tranformations can be save as a Predictive Model Markup Language (PMML) file to faciliate predictive model deployment. 
