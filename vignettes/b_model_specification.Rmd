...
### Variable roles
`bllflow` can assign one or more roles to each variable in the data (i.e., variables can have multiple roles). We add a role for each variable that is used in our study. Suggested can be named anything and be used or reused for any purpose. Suggested roles include:
