...
- DDI (xml) files. Use DDI files ([Data Document Initiative](https://www.ddialliance.org)) to add labels, units, type, variableType and other metadata. [Helper and utility functions](vignettes/i_helper_functions.Rmd) shows examples of adding DDI metadata to the MSW. 
