...
```{r}
attach(pbc)
allvars <- as.data.frame(cbind(trtC, age_rcs_vec2, bili_rcs_vec2))
detach(pbc)
str(allvars)
```
The allvars object contains 7 variables.
...
We also need to know the baseline risk of the event at time t. Here I will show how to obtain baseline risk at 5 years:
