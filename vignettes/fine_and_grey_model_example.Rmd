...
CreateBLLModelObject(pbc, pbc_crr_model, modelPbcTableOne)
```

# Generate a bllflow model object
This object is used to generate the PMML file, for manuscript figures and other uses.

CreateBLLModelObject(modelObject, modelType, tableOne, ModekData)
...
pbcTableOne = CreateTableOne(pbc)
CreateBLLModelObject(modelObject = pbc_crr_model, tableOne = pbcTableOne, modelData = pbc)
